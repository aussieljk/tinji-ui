...
await tinji.notifications.subscribers.retrieve('user_abc123');`;

  const workflows = `// Trigger a notification workflow
await tinji.notifications.workflows.trigger({
...
const isValid = tinji.notifications.utils.verifySignature({
  payload: req.body,
  signature: req.headers['x-tinji-signature'],
