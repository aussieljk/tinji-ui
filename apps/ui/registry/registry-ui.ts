...
export const ui: Registry["items"] = [
  ...
  },
  {
    ...
    files: [
      ...
      {
        path: "blocks/dashboard-01/components/stat-cards.tsx",
        type: "registry:component",
      },
      {
        path: "blocks/dashboard-01/components/orders-table.tsx",
        type: "registry:component",
      },
    ],
    name: "dashboard-01",
  ...
  },
  {
    ...
    dependencies: ["lucide-react"],
    description: "",
    files: [{ path: "blocks/signup-01/page.tsx", type: "registry:block" }],
    name: "signup-01",
    registryDependencies: [
      "@tinji/button",
      "@tinji/card",
  ...
  },
  {
    ...
    dependencies: ["lucide-react"],
    description: "",
    files: [{ path: "blocks/pricing-01/page.tsx", type: "registry:block" }],
    name: "pricing-01",
    registryDependencies: [
      "@tinji/badge",
      "@tinji/button",
  ...
  },
  {
    categories: ["settings"],
    description: "",
    files: [{ path: "blocks/settings-01/page.tsx", type: "registry:block" }],
    name: "settings-01",
    registryDependencies: [
      "@tinji/avatar",
      "@tinji/button",
