...
export const particles: ParticleItem[] = [
  ...
  },
  {
    ...
    files: [{ path: "particles/p-typography-1.tsx", type: "registry:block" }],
    name: "p-typography-1",
  ...
  {
    categories: categories("segmented control"),
    description: "Segmented control for switching between options",
    files: [
      { path: "particles/p-segmented-control-1.tsx", type: "registry:block" },
    ],
  ...
  },
  {
    ...
    files: [
      { path: "particles/p-segmented-control-2.tsx", type: "registry:block" },
    ],
  ...
  },
  {
    ...
    files: [
      { path: "particles/p-segmented-control-3.tsx", type: "registry:block" },
    ],
  ...
  {
    categories: categories("tabs nav"),
    description: "Navigation tabs rendered as links with active state",
    files: [{ path: "particles/p-tabs-nav-1.tsx", type: "registry:block" }],
    name: "p-tabs-nav-1",
    registryDependencies: ["@tinji/tabs-nav"],
    type: "registry:block",
  },
  {
    categories: categories("filter chip"),
    dependencies: ["lucide-react"],
    description: "Toggleable filter chip with selected state and dismiss",
    files: [{ path: "particles/p-filter-chip-1.tsx", type: "registry:block" }],
    name: "p-filter-chip-1",
    registryDependencies: ["@tinji/filter-chip"],
    type: "registry:block",
  },
  {
    categories: categories("radio button group"),
    description: "Radio group styled as selectable cards",
    files: [
      { path: "particles/p-radio-button-group-1.tsx", type: "registry:block" },
    ],
  ...
  },
  {
    ...
    files: [{ path: "particles/p-data-list-1.tsx", type: "registry:block" }],
    name: "p-data-list-1",
    registryDependencies: ["@tinji/data-list"],
    type: "registry:block",
  },
  {
    categories: categories("stacked bar chart"),
    description: "Stacked horizontal bar chart with a legend",
    files: [
      {
        path: "particles/p-stacked-horizontal-bar-chart-1.tsx",
        type: "registry:block",
      },
    ],
  ...
  {
    categories: categories("date field"),
