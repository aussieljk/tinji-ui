# tinji Component Registry Index

Use this file to quickly identify the right tinji primitive for a UI task. Each entry includes the component name, a one-line purpose, and the path to its reference guide (relative to the skill root `apps/ui/skills/tinji/`).
