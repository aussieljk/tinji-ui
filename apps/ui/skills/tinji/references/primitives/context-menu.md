...
```bash
npx shadcn@latest add @tinji/context-menu
```
...
Also include the destructive foreground CSS variable snippet from the tinji context menu docs when doing manual setup.
