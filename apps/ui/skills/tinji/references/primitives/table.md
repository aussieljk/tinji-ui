...
```bash
npx shadcn@latest add @tinji/table
```
...
- **Interactive data grids**: pair tinji table parts with TanStack Table (`flexRender`, row models, selection state) for sorting/pagination/selection.
